...
model_h2_test <- lmer(objective_difficulty_score ~ perceived_difficulty_score + (1|id_participant) +  (1|theme), data = dataset_for_h2)
...
model_h2_test_bis <- lmer(objective_difficulty_score ~ perceived_difficulty_score + (1 + perceived_difficulty_score |id_participant), data = dataset_for_h2)
...
#Variant: two random intercepts
model_h3p_test_max <- lmer(average_objective_performance_score ~ perceived_performance_score + (1+ perceived_performance_score |id_participant) + (1+ perceived_performance_score |theme), data = dataset_for_h3p)

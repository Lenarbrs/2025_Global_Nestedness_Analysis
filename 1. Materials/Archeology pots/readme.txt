...
mississippi : 20 observations (assemblages) and 10 variables (ceramic types) --> not fit for analysis ? (no Indeed)
(NO)

zuni : 420 observations (assemblages) and 18 variables (ceramic types) --> not fit for analysis ? (no Indeed)
(NO)

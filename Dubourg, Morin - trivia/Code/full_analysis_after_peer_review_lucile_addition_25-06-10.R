...
# LUCILE ADDITION ####
#Heroes
dataset_nestedness_superheroes
write.csv(dataset_nestedness_superheroes, "superheroes.csv", row.names = FALSE)
#Solar
dataset_nestedness_solarsystem
write.csv(dataset_nestedness_solarsystem, "solarsystem.csv", row.names = FALSE)

#History
dataset_nestedness_americanhistory
write.csv(dataset_nestedness_americanhistory, "americanhistory.csv", row.names = FALSE)
